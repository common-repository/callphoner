=== CallPhone'r ===
Contributors: wpshopbiz, dmbur, mojwp
Donate link: https://wpshop.ru/donate
Tags: call, mobile, phone, button, contact, e-commerce, iphone, android
...
1. Setup button design / Настройка дизайна кнопки
2. Setup schedule of a button / Настройка времени работы кнопки
